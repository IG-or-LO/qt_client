...
bool klientDataBase::insertIntoMessageTable(const QString &user_from, const QString &user_to, const QString &message, const QString &data)
{
    QSqlQuery query;
...
bool klientDataBase::updateStatusMessageTable(const QString mess_id, const QString user, const QString status)
{
